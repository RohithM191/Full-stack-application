...
const TextAbove = () => (
  <div className="bold">
    ...
    <p>2.4.4 Acceptance (ACP) message<br/>
     2.4.4.1 Composition </p>
  </div>
);

export default function LineButton() {
  const lines = [
  <h3><p> 2.4.4.2 Submitted  Acceptance (ACP) message</p><br/>
  ...
  return (
    <div className="App">
      ...
      <div className="row">
        ...
        <MyCanvas number="13" content="Departure aerodrome and times" /><p>-</p>
      </div>
